...
// Helper de login para los e2e de seguridad multi-rol (bloque U).
// Difiere del _helpers/auth.ts compartido: aquel solo conoce los 4 roles
// con storageState pre-generado (admin/taller/marca/estado). Estos specs
// necesitan cuentas dedicadas sin storageState (dual, taller_oro/bronce,
// u09), por eso hacen form-login directo cada vez.
// Portado desde e2e/helpers/auth.ts (directorio huerfano) — ver T-04.
