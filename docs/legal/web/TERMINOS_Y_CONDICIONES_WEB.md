...
El presente documento establece los términos y condiciones que regulan el uso de la Plataforma Digital Textil (en adelante, "la Plataforma" o "PDT"), un servicio digital desarrollado por la Universidad Nacional de Tres de Febrero (UNTREF) con el apoyo de la Organización Internacional del Trabajo (OIT).

El acceso y uso de la Plataforma implica la aceptación plena y sin reservas de los presentes términos. Los usuarios que no acepten estas condiciones deben abstenerse de utilizar la Plataforma.

---

## 2. Descripción del servicio

La Plataforma tiene por finalidad vincular a los actores del sector textil argentino, con foco inicial en el Área Metropolitana de Buenos Aires, brindando las siguientes funcionalidades principales:

- Registro y perfil profesional para talleres textiles.
- Directorio público de talleres verificados.
- Publicación de pedidos por parte de marcas y postulación por parte de talleres.
...
Para registrarse y utilizar la Plataforma, el Usuario debe:

- Ser mayor de edad conforme a la legislación argentina.
- Contar con Clave Única de Identificación Tributaria (CUIT) activa, en el caso de los roles Taller y Marca.
...
El Usuario se compromete a utilizar la Plataforma de buena fe y conforme a los presentes términos, la Política de Privacidad y la normativa vigente. Queda expresamente prohibido:
...
Adicionalmente, el uso de la Plataforma debe realizarse conforme a los estándares éticos internacionalmente aceptados. La Plataforma adhiere a una política de tolerancia cero frente a prácticas fraudulentas, amenazas, acoso o cualquier forma de conducta abusiva.

---

## 7. Contenido cargado por el Usuario

El Usuario es el único responsable del contenido que carga en la Plataforma, incluyendo perfil, descripciones, imágenes, documentación y cualquier información asociada a su cuenta.

Al cargar contenido, el Usuario declara que:

- Cuenta con las autorizaciones necesarias para difundir dicho contenido en la Plataforma.
- No infringe derechos de propiedad intelectual, imagen ni cualquier otro derecho de terceros.
- La información es veraz y verificable.

El equipo responsable de la Plataforma podrá remover contenido que resulte inapropiado, falso o que infrinja los presentes términos, notificando al Usuario cuando corresponda.
...
## 9. Verificación de datos y privacidad
...
La Plataforma se reserva el derecho de suspender o dar de baja cuentas en los siguientes casos:

- Incumplimiento reiterado o grave de los presentes términos.
- Detección de información falsa o fraudulenta.
- Solicitud del propio Usuario.
- Inactividad prolongada, conforme al procedimiento que la Plataforma comunique con antelación.
- Vencimiento del período de gracia sin verificación válida de CUIT.
...
La Plataforma aplica medidas técnicas y organizativas razonables para proteger los datos de los Usuarios, sin perjuicio de lo cual no puede garantizar de forma absoluta que terceros no autorizados nunca accederán a los datos.

---

## 12. Modificaciones a los términos

La Plataforma podrá modificar los presentes términos en cualquier momento, notificando a los Usuarios por los medios habituales de contacto y con antelación razonable cuando los cambios sean sustanciales.

El uso continuado de la Plataforma con posterioridad a la notificación implicará la aceptación de los términos modificados. Los Usuarios que no acepten los nuevos términos podrán dar de baja su cuenta conforme al procedimiento establecido.
