...
const sensibilidad: Record<string, { nivel: string; variant: 'error' | 'warning' | 'default' | 'muted' }> = {
  ...
  ESTADO_VALIDACION_APROBADA: { nivel: 'Alta', variant: 'warning' },
  ESTADO_VALIDACION_RECHAZADA: { nivel: 'Alta', variant: 'warning' },
  ESTADO_VALIDACION_REVOCADA: { nivel: 'Critica', variant: 'error' },
