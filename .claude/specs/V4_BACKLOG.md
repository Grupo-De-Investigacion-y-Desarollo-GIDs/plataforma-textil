...
| T-12 | estado/page Suspense refactor | Splitear las 15 queries de `prisma.$transaction` en `/estado/page.tsx` a child components async con Suspense boundaries. Excluido de UX V3 por complejidad: romper la transacción requiere verificar atomicidad de lectura | 2.5h |
