...
2bis. **C5 (`/api/upload/imagenes` contexto `cotizacion`, IDOR de escritura) — ✅ RESUELTO (diseño A — elegibilidad, `<SHA>`).** Gate por `elegibilidadCotizar` (fuente única compartida con `POST /api/cotizaciones`). Ver §5.2.
